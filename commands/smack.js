exports.run = (client, message, args) => {
  ...
  if(message.mentions.users.first().id === customisation.ownerid) return message.reply('You can\'t hurt him you zingus.');
  if(message.mentions.users.first().id == client.user.id && message.author.id !== customisation.ownerid) return message.reply('You can\'t hurt me you Marketable Plus Toy To Be Sold In Stores Near You.');
