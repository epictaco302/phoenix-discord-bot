...
exports.run = (client, message, customisation) => {
  ...
  ' with .NET based languages, such as C# and Visual Basic, as they are made by the same people.' +
  ' They also include a plugin system. [Download](https://visualstudio.microsoft.com/)')
  .addField('Atom','Atom is a code editor based on Electron (a Chromium wrapper). It\'s made by' +
  ' GitHub, and has a massive community, with plugins for everything. [Download](https://atom.io/)')
  .addField('VS Code','VS Code is another editor based off of Electron, but' +
  ...
  ' It\'s the fastest text editor that I\'ve personally seen. There is also a' +
