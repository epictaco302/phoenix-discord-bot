...
exports.run = (client, message, args, customisation) => {
  if(!args[0]){
      ...
      .addField("Here is a list of all the commands of this bot.")
      .addField("For more info about a specific Command:", "Use tb!help command_name")
    ...
    if (message.author.id === customisation.ownerid) {
      ...
      message.author.send({embed}).catch(e =>{
        if (e) {
        message.channel.send(`Huh. You seems to be locking your DMs, so I'll send it here instead.`);
