exports.run = function(client, message, args, customisation) {
  ...
  if(args[0] === 'all') {
    ...
    if(parseInt(args[1]) > 100) return message.channel.send("I can only delete max 100 messages at a time.")
    ...
    if(parseInt(args[2]) > 100) return message.channel.send("I can only delete max 100 messages at a time.")
