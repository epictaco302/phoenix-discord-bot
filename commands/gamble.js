...
exports.run = (client, message, args) => {
  ...
  Coins.findOne({
    ...
    if(!coins){
      ...
      newcoins.save()
      message.channel.send(`<@${user.id}>, you don't have any coins yet. Start off with \`daily\` :<`)
    }else{
      ...
      if (money > 2500) return message.reply("Due to disgusting abusers of the casino, you can only bet 2500 coins at max ;-;")
