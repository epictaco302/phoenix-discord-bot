...
exports.run = (client, message, args, customisation) => {
  ...
  if (user.id === client.user.id) return message.reply("Are you smooth-brained? How can you use a bot to kick itself?");
  
  if (message.mentions.users.first().id === customisation.ownerid) return message.reply("I ain't gonna let you kick my developer, lol.");
