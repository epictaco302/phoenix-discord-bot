...
exports.run = (client, message, args, customisation) => {
  ...
  if (!message.member.hasPermission("BAN_MEMBERS")) return message.reply(":x: You don't have the **Ban Members** permission!");
  ...
  if (message.mentions.users.first().id === customisation.ownerid) return message.reply("I ain't gonna let you ban my developer, lol.");
